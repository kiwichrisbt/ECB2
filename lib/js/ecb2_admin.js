...
$(function() {
    ...
    function ECB2TinyMCEAdd ($editorId) {
        var isTinyMCE8Plus = tinymce.majorVersion >= 8 || (tinymce.majorVersion === undefined && parseInt(tinymce.version) >= 8);
        
        if (isTinyMCE8Plus) {
            // TinyMCE 8+ - initialize new editor
    ...
    function ECB2RepeaterEditorAdd ($repeater, $newRepeaterWrapper) {
        ...
        //     // Check TinyMCE version - v8+ uses majorVersion, older uses just version
        //     var isTinyMCE8Plus = tinymce.majorVersion >= 8 || (tinymce.majorVersion === undefined && parseInt(tinymce.version) >= 8);
        ...
        //             setup: function(editor) {
        //                 editor.on('init', function() {
        //                     // Remove hidden styles after editor is initialized
